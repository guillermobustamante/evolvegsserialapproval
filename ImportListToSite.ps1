...
$list1= "DocumentsApproval"
$webURL="https://evolvegs.sharepoint.com/sites/TeamSite"
...
Invoke-PnPSiteTemplate -Path "$outputfolderpath/DocumentsApprovalListToSite.xml"
Invoke-PnPSiteTemplate -Path "$outputfolderpath/ListPnPSiteTemplates.xml"
Set-ListFormatting -folderPath $outputfolderpathFormatting -listName $list1